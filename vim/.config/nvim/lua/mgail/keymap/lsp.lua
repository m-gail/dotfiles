...
nmap("gs", ":TSToolsGoToSourceDefinition<CR>", "go to TS source definition")
...
nmap("<leader>sio", ":TSToolsOrganizeImports<CR>", "Organize TS imports")
nmap("<leader>sir", ":TSToolsRemoveUnusedImports<CR>", "Remove unused TS imports")
nmap("<leader>sia", ":TSToolsAddMissingImports<CR>", "Add missing imports")
